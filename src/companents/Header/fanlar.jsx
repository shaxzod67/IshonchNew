             ...
             <div id="fanlar" className="container px-5 py-24 mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row sm:flex-wrap md:flex-row md:flex-wrap lg:flex-row xl:flex-row -m-4">
                        <div className="p-4 lg:w-1/4 sm:w-1/2 w-full">
                            <h2 className="font-medium title-font tracking-widest text-white mb-4 text-sm text-center sm:text-center">Kimyo</h2>
                        ...
                        <div className="p-4 lg:w-1/4 sm:w-1/2 w-full">
                            <h2 className="font-medium title-font tracking-widest text-white mb-4 text-sm text-center sm:text-center">Biologiya</h2>
                            <div className="flex justify-around">
                                <nav className="flex flex-col sm:items-start sm:text-left -mb-1 space-y-2">
                                    <a>
                                        <span className="bg-gray-800 text-indigo-400 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
                        ...
                        <div className="p-4 lg:w-1/4 sm:w-1/2 w-full">
                            <h2 className="font-medium title-font tracking-widest text-white mb-4 text-sm text-center sm:text-center">Tarix</h2>
                            <div className="flex justify-around">
                                <nav className="flex flex-col sm:items-start sm:text-left -mb-1 space-y-2">
                                    <a>
                                        <span className="bg-gray-800 text-indigo-400 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
                        ...
                        <div className="p-4 lg:w-1/4 sm:w-1/2 w-full">
                            <h2 className="font-medium title-font tracking-widest text-white mb-4 text-sm text-center sm:text-center">Matematika</h2>
                            <div className="flex justify-around">
                                <nav className="flex flex-col sm:items-start sm:text-left -mb-1 space-y-2">
                                    <a>
                                        <span className="bg-gray-800 text-indigo-400 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
