 ...
 const {dispatch} = useContext(AuthContext);
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="relative sm:mb-0 flex-grow w-full">
      ...
      <button onClick={handleSubmit} type="submit" className="button1" >Kirish</button>
      <button type="submit" className="button2" ><Link className="link" to="/signup">Ro'yhatdan o'tish</Link> </button>
